...
function ChatRooms() {
  ...
  return (
    <div 
      className="min-h-screen text-zinc-900 bg-cover bg-center bg-fixed" 
      style={{ backgroundImage: "url('/chatbg.png')" }}
    >
      {/* Transparent overlay for better readability */}
      <div className="bg-white/80 dark:bg-black/60 min-h-screen">
        ...
        <header className="sticky top-0 z-40 w-full backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/80 border-b border-zinc-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold tracking-tight text-gray-900 select-none">VIBE TALKZ</span>
            </div>
          </div>
        </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="relative p-8 flex flex-col lg:flex-row items-center gap-8">
              <div className="flex-1">
                ...
                <p className="mb-5 text-gray-100/90 leading-relaxed max-w-xl">
                  Explore our most active space and meet people already chatting. Jump in or pick another room below.
                </p>
                <button
          ...
          <div className="mt-16 pt-8 border-t border-gray-200 text-center">
            <a href="https://kishorer.vercel.app/" target="_blank" className="text-sm text-gray-500">
              © 2025 Vibe Talkz. Developed By KISHORE R
            </a>
          </div>
        </div>
      </div> {/* overlay close */}
